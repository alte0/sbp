...
// ===================================================================================================
// webpackStream for prodaction
// ===================================================================================================
gulp.task('js:prod', function () {
  var webpackConfigProd = require('./prod.config.js');
  return gulp
    .src("./src/js/main.js")
...
var initBrowserSync = function(){
    return browserSync.init({
        ...
        files: ["./dist", './src/pug/**/*', './src/js/**/*', './src/fonts', './src/i', './src/images'],
...
gulp.task('default', function() {
  runSequence('clean-all',
              'isNoBs',
              // ['sass', 'images', 'i', 'sprites', 'fonts', 'js-lib', 'js-App'],
...
gulp.task('dev', function() {
  runSequence('clean-all',
    ['pug', 'sass', 'sprites','watch', 'browser-sync']
              );
});
